...
{
	//GEngine->AddOnScreenDebugMessage(1, 2.f, FColor::Blue, FString("GetHitRun"));
	...
	//UKismetSystemLibrary::DrawDebugArrow(this, GetActorLocation(), ImpactLowered, 5.f, FLinearColor::Blue, 5.f);
	//UKismetSystemLibrary::DrawDebugArrow(this, GetActorLocation(), GetActorLocation()+ GetActorForwardVector()*50.f, 5.f, FLinearColor::Red, 5.f);
	...
	if (HitSounds)
	{
		UGameplayStatics::PlaySoundAtLocation(this, HitSounds, GetActorLocation());
	}
	if (HitParticles)
	{
